...
public class PopularFragment extends Fragment {
    ...
    private static final String POPULARS_URL = TestRappiApplication.BASE_URL_API + "&sort_by=title.asc";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.popular_fragment, container, false);
     ...
     */
    private void fetchPopulars() {

        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, POPULARS_URL,
